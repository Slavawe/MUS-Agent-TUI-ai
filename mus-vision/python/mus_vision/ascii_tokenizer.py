"""
MUS ASCII Vision Tokenizer — Python обёртка над Rust-ускорителем.
...
from mus_vision._core import ASCIITokenizer as _RustTokenizer
...
class ASCIITokenizer:
    """Быстрый ASCII-токенизатор на Rust с прямой интеграцией numpy."""
    ...
    def encode_image(self, image: np.ndarray, mode: Optional[str] = None) -> List[int]:
        """RGB (H,W,3) или grayscale (H,W) → ASCII-токены. Zero-copy через PyBuffer."""
